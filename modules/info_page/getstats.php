...
function getStats() {
	...
	foreach($entities as $entity) {
		...
		if (count($entity->xpath(".//mdui:InformationURL[@xml:lang='en']")) > 0 &&
		    count($entity->xpath(".//mdui:InformationURL[@xml:lang='it']")) > 0) {
			$output["ok"][] = $curentity;
		} elseif (count($entity->xpath(".//mdui:InformationURL[@xml:lang='en']")) > 0) {
			$output["only_en"][] = $curentity;
		} elseif (count($entity->xpath(".//mdui:InformationURL[@xml:lang='it']")) > 0) {
